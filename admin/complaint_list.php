...
function myFunction() {
            ...
            <div class="row">         
                <div class="col-md-12 col-sm-12 col-xs-12">                     
                    <div class="panel panel-default">
                            ...
                            <h2 align="center">List Of All Complaints</h2> 
                        </div>
  ...
  <center><button class = "no-print" onclick="myFunction()">Print Report</button>
  <a class = "no-print" href="index.php?listall"><input class = "no-print" type="button" value="Back" /></a></center>
