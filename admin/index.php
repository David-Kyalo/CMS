...
<head>
    ...
    <style>
        body {
            background-color: #F0F8FF; /* Alice Blue for a soft background */
            font-family: 'Open Sans', sans-serif;
            color: #071952; /* Navy Blue for text */
        }
        .navbar {
            background-color: #071952; /* Navy Blue */
            border-bottom: 2px solid #37B7C3; /* Cyan */
        }
        .navbar-brand {
            color: #37B7C3 !important; /* Cyan */
        }
        .navbar-brand:hover {
            color: #088395 !important; /* Teal */
        }
        .navbar-header {
            background-color: #071952; /* Navy Blue */
        }
        ...
        .btn-danger.square-btn-adjust {
            background-color: #088395; /* Teal */
            border-color: #088395; /* Teal */
            color: #F0F8FF; /* Light text color */
        }
        .btn-danger.square-btn-adjust:hover {
            background-color: #37B7C3; /* Cyan */
            border-color: #37B7C3; /* Cyan */
            color: #071952; /* Navy Blue */
        }
        .sidebar-collapse {
            background-color: #071952; /* Alice Blue */
        }
        ...
        .sidebar-collapse ul.nav > li > a:hover {
            background-color: #37B7C3; /* Cyan */
            border-left: 4px solid #088395; /* Teal */
            color: #F0F8FF; /* Light text color */
        }
        .user-image {
            border-radius: 50%;
            border: 2px solid #071952; /* Navy Blue */
        }
    </style>
</head>
<body>
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    <li class="text-center">
                        <img src="../pexels5.jpg" class="user-image img-responsive"/>
                    </li>
                    <li>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            while($temp = $result->fetch_assoc()){
                                ...
                                echo  '<td>'.$temp['APT_BLOCK'].'</td>'; 
                                echo  '<td>'.$temp['APT_NUM'].'</td>'; 
                                echo  '<td>'.$temp['NAME'].'</td>'; 
                                echo  '<td>'.$temp['REMAIL'].'</td>'; 
